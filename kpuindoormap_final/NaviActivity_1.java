...
public class NaviActivity_1 extends Activity implements OnBeaconCallBackListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mBtnFloor = (Button)findViewById(R.id.btn_floor); // 층선택 변수.
        ...
        {
            // StartActivityForResult << 메소드 쓰기.
            @Override
            public boolean onTouch(View v, MotionEvent event)
            {
                if (event.getAction() == MotionEvent.ACTION_UP)
                {
                    startActivityForResult(new Intent(NaviActivity_1.this, SearchActivity.class), 0x00);
                }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.floor_b1:
                        Intent intent = new Intent(NaviActivity_1.this, NaviActivity_b1.class);
            ...
            if(beacons.get(0) != null) {
                ...
                if(beaconInfo != null) {
                    ...
                    if (beaconInfo.getMajor() == 19523 && beaconInfo.getMinor() == 16707 && check1 && beacons.get(0).getDistance() < 2f) {
                        check1 = false;
                        Intent intent = new Intent(NaviActivity_1.this, PopupActivity.class);
                        startActivity(intent);
                    ...
                    //치킨톡
                        ...
                        check2 = false;
                        Intent intent = new Intent(NaviActivity_1.this, PopupActivity2.class);
                        startActivity(intent);
                    }
                    // 베이커리
                    else if (beaconInfo.getMajor() == 19523 && beaconInfo.getMinor() == 16706 && check3 && beacons.get(0).getDistance() < 2f) {
                        check3 = false;
                        Intent intent = new Intent(NaviActivity_1.this, PopupActivity3.class);
                        startActivity(intent);
                    }
                }
            }
